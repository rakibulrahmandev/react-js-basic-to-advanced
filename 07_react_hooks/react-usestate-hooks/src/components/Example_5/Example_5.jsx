    ...
    return (
        <>
            <div className="w-[400px] min-h-[200px] bg-gray-950 flex items-center justify-center flex-col gap-10 rounded-md p-5">
                ...
                <button onClick={increase} className="w-[140px] py-3 border border-gray-700 font-medium text-lg text-gray-700 rounded-md cursor-pointer transition-colors duration-100 ease-in hover:bg-gray-700/20">Increase</button>
            </div>
        </>
    )
}